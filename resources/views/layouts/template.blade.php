...
<head>
  ...
  <title>@yield('judul') Balita</title>
  <meta content="" name="description">
  <meta content="" name="keywords">

  <!-- Favicons -->
  <link href="{{asset('/tema/img/icon.png')}}" rel="icon">
  <link href="{{asset('tema/img/icon.png')}}" rel="icon-icon">
...
<body>
  ...
  <header id="header" class="header fixed-top">
    <div class="container-fluid container-xl d-flex align-items-center justify-content-between">
      ...
      <a href="{{url('/')}}" class="logo d-flex align-items-center">
        <img src="{{asset('tema/img/icon.png')}}" alt="">
      ...
      <nav id="navbar" class="navbar">
        <ul>
          ...
          <li><a href="{{url('/sewa-mobil')}}">Rekomendasi</a></li>
          <li><a href="{{url('/cara-pesan')}}">Cara Penanganan</a></li>
  ...
  <footer id="footer" class="footer">
      ...
      <div class="container">
        <div class="row gy-4">
          <div class="col-lg-5 col-md-12 footer-info">
            ...
            <p>Kami Menyediakan Pelayanan Keshatan Balita.</p>
          ...
          <div class="col-lg-3 col-md-12 footer-contact text-center text-md-start">
            ...
            <p>
              ...
              <strong>Email:</strong>balitasehat123@gmail.com<br>
            </p>
    ...
    <div class="container">
      <div class="copyright">
        &copy; Copyright <strong><span>Kesehatan Balita</span></strong>. All Rights Reserved
      </div>
      <div class="credits">
